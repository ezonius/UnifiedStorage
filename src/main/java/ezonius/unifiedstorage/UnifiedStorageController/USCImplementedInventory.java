 ...
 * Originally by Juuz
 */
public interface USCImplementedInventory extends Inventory {
    /**
     ...
     */
    static USCImplementedInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     */
    static USCImplementedInventory ofSize(int size) {
